...
const experienceComponent = (data = {}) => {
  ...
  // console.log(data);
  return `<svg xmlns="http://www.w3.org/2000/svg" width="${role!= undefined || duration != undefined || location!=undefined ? "400" : "150"}" height="200">
  <style>
  ${experienceComponentStyles(fill)}
  </style>
<foreignObject width="${role!= undefined || duration != undefined || location!=undefined ? "400" : "150"}" height="200">
  ...
  ${ role!= undefined || duration != undefined || location!=undefined ?`<div class="details">
    ${role != undefined ?
    `<div class="position">
      <div class="title">
        ${roleSVG(fill)}
