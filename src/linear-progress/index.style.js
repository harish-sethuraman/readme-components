  ...
  return `* {
    ...
    margin: 0 0 10px;
      ...
      .progress.candy .ProgressBars {
        ...
        -webkit-animation: candystripe 1s linear infinite,width 2s;
        -moz-animation: candystripe 1s linear infinite,width 2s;
        animation: candystripe 1s linear infinite,width 2s;
      }
      ...
      .progress.neon .ProgressBars {
        ...
        box-shadow: 0 0 5px #01fe32 inset, 0 0 16px #08ff35, 0 0 20px #08ff35,
          0 0 15px #08ff35;
        -webkit-animation: pulse 2s linear infinite,width 2s;
        -moz-animation: pulse 2s linear infinite,width 2s;
        animation: pulse 2s linear infinite,width 2s;
      }
      ...
      .progress.shine .ProgressBars {
        ...
        -webkit-animation: shine 2s linear infinite,width 2s;
        -moz-animation: shine 2s linear infinite,width 2s;
        animation: shine 2s linear infinite,width 2s;
      }
      ...
      .progress.zigzag .ProgressBars {
        ...
        background-size: 20px 20px;
        -webkit-animation: zigzagmove 0.5s linear infinite,width 2s;
        -moz-animation: zigzagmove 0.5s linear infinite,width 2s;
        animation: zigzagmove 0.5s linear infinite,width 2s;
      }
      ...
      .progress.diamond .ProgressBars {
        ...
        -webkit-animation: move 1.2s linear alternate infinite,width 2s;
        -moz-animation: move 1.2s linear alternate infinite,width 2s;
        animation: move 1.2s linear alternate infinite,width 2s;
      }
      ...
      .progress.sparkle .ProgressBars {
        ...
        box-shadow: inset 0 -2px 2px rgba(0, 0, 0, 0.5),
          inset 0 2px 2px rgba(255, 255, 255, 0.8);
        -webkit-animation: sparkle 1500ms linear infinite,width 2s;
        -moz-animation: sparkle 1500ms linear infinite,width 2s;
        -o-animation: sparkle 1500ms linear infinite,width 2s;
        animation: sparkle 1500ms linear infinite,width 2s;
      }
      ...
      .progress.hearts .ProgressBars {
        ...
        -webkit-animation: heartmove 1.2s linear infinite,width 2s;
        -moz-animation: heartmove 1.2s linear infinite,width 2s;
        animation: heartmove 1.2s linear infinite,width 2s;
      }
